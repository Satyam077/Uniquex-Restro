...
namespace AbbyWeb.Pages.Customer.Home
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public void OnGet(int id)
        {
            ...
            MenuItem = _unitOfWork.MenuItem.GetFirstOrDefault(u => u.Id == id, includeproperties: "Category,FoodType"),MenuItemId = id
            };
        }
        ...
        public IActionResult OnPost()
        {
            ...
            {        
                ...
                //if null found in DB then add to Cart else increment cart
